package com.shoumik.component;

import com.shoumik.app.MessageType;
import com.shoumik.emoji.Emogi;
import com.shoumik.emoji.Model_Emoji;
import com.shoumik.event.PublicEvent;
import com.shoumik.main.Main;
import com.shoumik.model.Model_Send_Message;
import com.shoumik.model.Model_User_Account;
import com.shoumik.service.Service;
import com.shoumik.swing.ScrollBar;
import com.shoumik.swing.WrapLayout;
...
public class Panel_More extends javax.swing.JPanel {
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/shoumik/icon/image.png")));
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/shoumik/icon/link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();
