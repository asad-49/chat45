...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/shoumik/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/shoumik/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.shoumik.swing.JIMSendTextPane();
    ...
    private com.shoumik.swing.JIMSendTextPane txt;
